...
tree lined streets, meant to exemplefy the beauty of a monospecific
tree lined street and highlight each species' characteristics (Fig. [[fig:red_oak_street]]).

#+name: fig:red_oak_street
#+caption: Plate 9 - Street of Red Oaks from Solotaroff 1911.  Original Text: Twelfth Street, West, between North and South B Streets, Washington, D. C. Twenty years old.
[[file:blog/blog_imgs/Street Tree History Time Warp/red_oak_street_DC_2018-05-30_09-29-21.jpg]]

I tried finding these streets on google street view to see if the trees
still existed.  I checked a few and found the trees gone and the
streets radically transformed.  Some of the streets were on what would
be come the national mall and didn't survive the [[https://en.wikipedia.org/wiki/McMillan_Plan][McMillan plan]].



the ginkgos and the usda building didn't survive the
