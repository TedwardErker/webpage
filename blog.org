...
* Finding the trees for the urban forest

I recently found the [[https://github.com/Jean-Romain/lidR/][=lidR= package]], an incredible tool for working
with lidar data in R.  I used it to separate trees from buildings.
See [[https://github.com/TedwardErker/lidR_urban_trees][my github repository]] for the code and explanation.  Below is an
example of the results.

[[file:blog/blog_imgs/finding_trees/marquette_small.gif]]

* Stan on CHTC.

The final assignment for the open science grid user school was to
write about how we could take what we learned at the school and apply
it to our work.  I decided to figure out how to get Stan, "a
state-of-the-art platform for statistical modeling and
high-performance statistical computation", running on a high
throughput system.  I hope the [[https://github.com/TedwardErker/chtc_stan][github repo]] I created will be helpful
for my research and others trying to run Stan on a cluster.

https://github.com/TedwardErker/chtc_stan

-----------------------------

** COMMENT make it citable?

https://research-it.berkeley.edu/blog/18/07/23/guides-making-research-software-reproducible-citable-and-well-documented

* My second paper published! [2019-07-31 Wed] 
:PROPERTIES:
:ID:       C99D60DC-A5DC-4E04-B2A9-6C84F6E6B95D
:Attachments: Screenshot%202019-08-26%2017.12.15_2019-09-03_12-40-11.png
:END:

#+DOWNLOADED: /Users/erker/Dropbox/Screenshots/Screenshot 2019-08-26 17.12.15.png @ 2019-09-03 12:40:11
[[file:data/C9/9D60DC-A5DC-4E04-B2A9-6C84F6E6B95D/Screenshot 2019-08-26 17.12.15_2019-09-03_12-40-11.png]]

I'm very proud of this [[https://doi.org/10.1088/2515-7620/ab37fd][one]].  It's years of work cut out and the rest
condensed into a small space. In addition to my advisor, Phil
Townsend, I'm grateful to Chris Kucharik for his guidance.

The review process really helped improve the text to be more clear.  I
submitted a version of this paper for Steve Carpenter's Ecosystem
Concepts class.  He didn't think very much of the paper and said that
it would be unlikely to be published because the statistical
significance was so low.  At first I was bothered by this comment
because actually the results were very clear statistically - it was
the effect size that was small.  I thought Steve was missing the
point.  But, rereading the paper I realized the burden was mine to
guide the reader to understand the nature of the study, the data, and
the relevance to science and society.  The final product is not
perfect, but it's a big improvement due in part to Steve's frank
criticism.

p.s. there is a small typo in the text introduced by the editor that I
didn't catch during the final proofs.  So it goes.

-----------------------------
* Open Science Grid User School [2019-07-15 Mon]
:PROPERTIES:
:ID:       8CF2418D-8CEC-497F-8CDD-9FF8AFD24FE7
:Attachments: p_2019-09-03_12-31-35.png
:END:

#+DOWNLOADED: https://ucd54df947ba22b34448f222afcb.previews.dropboxusercontent.com/p/thumb/AAil-8zukcR7qfnsIdCg5Mn8FTNIJWgXSKY7_btkW3e7DR6lWwB7IQ890oBo0NkH45Gt3uG8Xqp27d0wQzWf5xdIelAf48lGVhD_Qle-opiFVHDslZmT5acEf7fUJpppl-H68s-W7OxDaS7FVatdZgjoN39TxsiI5L3U2o94lxxfbpDdw6Up_X3Ups_KoT28GlbpxPKIKg7zhTzxFjKdXtJW_5UuMg7AG9UBAJYDNRaI2y_IdWjIYvnqZXa_5I8I8oli58gWr_XD1HV2ARUsaRz8iV9B1xIRMlD98Q88D3H1lFZBYUQynr6SFY69bZ5xSaoyufam2B5QrWT1d9bjFTAAKEn9cBewoBP9Wtx0i2jD0MKI1L5bHyEtgZQcs9q6KG2NBUOeC40dtPuJ77RzcS_nQsfWsAzRKXQGP7V62OILYsSfE9o68lRPmK2otK7NsJpYF0Fu8ASZ7Vgo472X_Po6pGqfPAwlZBN-Ki2-8rrWdQ/p.png?size=800x600&amp;size_mode=3 @ 2019-09-03 12:31:35
[[file:data/8C/F2418D-8CEC-497F-8CDD-9FF8AFD24FE7/p_2019-09-03_12-31-35.png]]

This July I participated in the [[https://opensciencegrid.org/user-school-2019/#][Open Science Grid User School]].  It was
an incredible learning opportunity.  With loads of hands-on exercises
over the course of a week we learned how to harness the power of a
high throughput system.  I had been familiar with using HTCondor from
my previous work, but this solidified things and allowed me to move to
next level of implementation.  It was a great group of learners and
teachers. 
...
file:blog/blog_imgs/constrainedRegression/predictions_dbh_bySpecies_wData_TIAM_thumb.png
...
#+RESULTS:
[[file:blog/blog_imgs/constrainedRegression/acpl_tpintw_quadfit_nodash.png]]
...
[[file:blog/blog_imgs/commute/frozenmad_isthmus_commute.jpg.png]]

#+ATTR_HTML: :alt none :title :align center
[[file:blog/blog_imgs/commute/ben_ski.jpg]]

#+ATTR_HTML: :alt none :title :align center
[[file:blog/blog_imgs/commute/ice.jpg]]

#+ATTR_HTML: :alt none :title :align center
[[file:blog/blog_imgs/commute/snowsun.jpg]]
...
[[file:blog/blog_imgs/stancon2018/frozenmad_isthmus.jpg]]

#+CAPTION:Flying out of Madison, picnic point and frozen lake Mendota
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/stancon2018/frozenmad_picnicpoint.jpg]]
...
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/stancon2018/stancon_hall.jpg]]
...
#+ATTR_HTML: :alt none :title :align center
[[file:blog/blog_imgs/stancon2018/pacificocean_asilomar.jpg]]
...
#+ATTR_HTML: :alt none :title :align center
[[file:blog/blog_imgs/stancon2018/Utah_mtns.jpg]]
...
|[[file:blog/blog_imgs/uhi_flyer/Screenshot 2017-12-05 19.18.51.png]]  | [[file:blog/blog_imgs/uhi_flyer/Screenshot 2017-12-05 19.19.02.png]] |
...
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/ap_es_east_fieldtrip/File_004.jpeg]]
...
[[file:blog/blog_imgs/DC_NASA_2017/NationalMuseumofAfricanAmericanHistoryandCulture_selfie.jpg]]

* Shotgun Training
[2017-05-16 Tue]

#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/ShotgunTraining/IMG_20170516_143233224.jpg]]

#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/ShotgunTraining/IMG_20170516_143231350.jpg]]

#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/ShotgunTraining/IMG_20170516_140129558.jpg]]

#+CAPTION: Zhihui
#+ATTR_HTML: :alt none :title :align center :height 600
[[file:blog/blog_imgs/ShotgunTraining/IMG_20170516_143207293-ANIMATION.gif]]
...
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/uhi_download_2017-04-25/IMG_20170425_135905884.jpg]]
...
#+ATTR_HTML: :alt none :title :align center :height 600
[[file:blog/blog_imgs/CoolScienceImage/beautiful_madison_lakes.png]]
...
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/FieldWorkUpNorth_Sep8-10/DSC01830.jpg]]

#+CAPTION: Jablonski grilling Aditya's Famous Chicken
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/FieldWorkUpNorth_Sep8-10/DSC01827.jpg]]

#+CAPTION: Always excited for field work
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/FieldWorkUpNorth_Sep8-10/DSC01835.jpg]]

#+CAPTION: Always excited for field work
#+ATTR_HTML: :alt none :title :align center :height 600
[[file:blog/blog_imgs/FieldWorkUpNorth_Sep8-10/DSC01839.jpg]]


#+CAPTION: Aditya fake shooting leaves (for retrieval)
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/FieldWorkUpNorth_Sep8-10/DSC01842.jpg]]

#+CAPTION: John fake writing
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/FieldWorkUpNorth_Sep8-10/DSC01875.jpg]]

#+CAPTION: Larch Stand
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/FieldWorkUpNorth_Sep8-10/DSC01881.jpg]]

#+CAPTION: NEON's Flux Tower.  Measuring the exhange of carbon between atmosphere and biosphere.  Sweet.
#+ATTR_HTML: :alt none :title :align center :height 400
[[file:blog/blog_imgs/FieldWorkUpNorth_Sep8-10/DSC01898.jpg]]
...
#+BEGIN_video
#+HTML:   <source src="blog/blog_imgs/FieldWorkUpNorth_Sep8-10/Ankur_FluxTower.mov">
#+END_video
...
#+ATTR_HTML: :alt none :title :align center :height 300
[[file:blog/blog_imgs/DC_NASA_meeting/with_einstein.jpg]]
...
[[file:blog/blog_imgs/free_seatpost/pull_apart.jpg]]
**** What did work:
...
4) Place frame in well ventilated area on something to catch any
   spills (I used a plastic sled in my driveway). [[file:blog/blog_imgs/free_seatpost/setup.jpg][setup]]
...
6) Pour solution into seat tube.  The solution needs to be up to the
   ...
   [[file:blog/blog_imgs/free_seatpost/bubbling.jpg][I cut mine too short and the paint was destroyed]]
...
#+ATTR_HTML: :alt none :title :align center :height 300
[[file:blog/blog_imgs/free_seatpost/remains.jpg]]
