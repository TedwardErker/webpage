...
U.S. is heating dominated (cold).  This isn't surprising, but is neat
...
CDD.  Summing the populations in each

this figures adds to Figure [[fig:hddcddUS]] bec also shows mild places
and clear inverse relationship

Look at Madison there.

#+name: fig:USpop_hdd_cdd_space
[[file:blog/blog_imgs/The U.S. Population in Heating and Cooling Degree Day Space/hdd_cdd_tracts_cities_2018-05-29_11-42-55_thumb.png]]
