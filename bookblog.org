...
#+HTML_DOCTYPE: html5
#+STARTUP: hideblocks
* 2018-03-08 Constrained regression for better tree growth equations :statistics:
2018-03-08 Thu
...
#+begin_src R :eval yes :session *R* :exports both :results graphics :file blog_imgs/constrainedRegression/acpl_tpintw_quadfit_nodash.png :height 200 :width 200 :eval no
library(ggplot2)
...
* 2017-12-05 Statistics and Elections                            :statistics:
...
* 2017-10-18 Flyer to get citizen help with urban forest research. :UrbanHeatIsland:
...
* 2017-05-24 Second Trip to Washington, DC for NASA's Biodiversity and Ecological Forecasting Team Meeting :nasa:travel:
...
* 2017-04-25 Collecting Urban Heat Island Data with Carly Ziter :UrbanHeatIsland:
#+ATTR_HTML: :alt none :title :align center :height 400
...
* 2016-08-02 Making this website                                    :orgmode:
...
* 2016-08-02 Trip to Washington, DC for NASA's Biodiversity and Ecological Forecasting Team Meeting :nasa:travel:
#+CAPTION: Albert Einstein Memorial
#+ATTR_HTML: :alt none :title :align center :height 300
[[file:blog_imgs/DC_NASA_meeting/with_einstein.jpg]]

* 2016-08-01 Removing Stuck Aluminum Seatpost from a Steel Frame       :bike:
