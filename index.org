...
Also, I love brilliant data visualizations and enjoy using them to
communicate science.
    ...
    (setq org-publish-project-alist
      ...
      <div id=\"doc-info\">
        ...
        at <a href=\"index.org\">index.org</a>
            ...
            ("webpage-static"
             :base-directory "~/projects/webpage_cv/"
             :base-extension "html\\|mov\\|css\\|js\\|png\\|jpg\\|gif\\|pdf\\|mp3\\|org\\|swf\\|ico"
             :publishing-directory "~/projects/webpage_out/"
...
#+begin_src sh :session a :results verbatim
  rsync -avz ~/projects/webpage_out/ erker@desk00.stat.wisc.edu:~/public/html/
#+end_src

#+results:
#+begin_example
erker@desk00.stat.wisc.edu's password:
...
sent 17921 bytes  received 1388 bytes  4290.89 bytes/sec
total size is 399683591  speedup is 20699.34
#+end_example
