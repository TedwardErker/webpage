...
dependent and large datasets in R.  Driven to understand problems in
depth and then distill key findings for nonexpert audiences via fully
reproducible literate programming reports and compelling figures.
