...
methods including GLMs, GAMs, shrinkage and dimension
reduction, tree-based methods, some bayesian techniques and
working with dependent and large datasets.




distilling the key point communicating with
